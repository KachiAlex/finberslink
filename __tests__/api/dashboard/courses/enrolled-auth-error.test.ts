...
/**
 * Auth Error Handling Tests - Enrolled Endpoint
 * 
 * **Validates: Requirements 2.3**
 * 
 * These tests verify that the enrolled endpoint correctly handles authentication errors
 ...
 */
describe("GET /api/dashboard/courses/enrolled - Auth Error Handling", () => {
  beforeEach(() => {
    jest.resetModules();
    jest.clearAllMocks();
  });
   ...
   * 
   * Validates: Requirement 2.3 (preservation)
   */
  it("should return 500 for non-auth errors", async () => {
    ...
    expect(body.error).toBe("Failed to fetch enrolled courses");
  });
});
