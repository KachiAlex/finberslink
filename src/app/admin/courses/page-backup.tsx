          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <Card className="border-amber-200 bg-amber-50">
              <CardContent className="p-4 text-center">
                <div className="text-2xl font-bold text-amber-700">{snapshot.totals.adminDrafts}</div>
                <div className="text-sm text-amber-600">Admin Drafts</div>
              </CardContent>
            </Card>
            <Card className="border-blue-200 bg-blue-50">
              <CardContent className="p-4 text-center">
                <div className="text-2xl font-bold text-blue-700">{snapshot.recentCourses.filter(c => c.approvalStatus === 'PENDING').length}</div>
                <div className="text-sm text-blue-600">Pending Review</div>
              </CardContent>
            </Card>
            <Card className="border-emerald-200 bg-emerald-50">
              <CardContent className="p-4 text-center">
                <div className="text-2xl font-bold text-emerald-700">{courses.filter(c => c.approvalStatus === 'APPROVED').length}</div>
                <div className="text-sm text-emerald-600">Published</div>
              </CardContent>
            </Card>
            <Card className="border-rose-200 bg-rose-50">
              <CardContent className="p-4 text-center">
                <div className="text-2xl font-bold text-rose-700">{snapshot.recentCourses.filter(c => c.approvalStatus === 'CHANGES').length}</div>
                <div className="text-sm text-rose-600">Needs Updates</div>
              </CardContent>
            </Card>
          </div>
