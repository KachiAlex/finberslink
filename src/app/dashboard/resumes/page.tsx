        ...
        {resumes.length === 0 ? (
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {resumes.map((resume) => (
              <div
                key={resume.id}
                className="group relative overflow-hidden rounded-xl border border-slate-200 bg-white transition-all duration-300 hover:-translate-y-1 hover:scale-105 hover:shadow-lg"
              >
                ...
                <div className="p-4">
                  ...
                  <div className="mt-4 flex gap-2 opacity-0 transition-opacity group-hover:opacity-100">
                    ...
                    <Button size="sm" variant="outline" className="flex-1" asChild>
                      <Link href={`/resume/${resume.slug}`} target="_blank" rel="noopener noreferrer">
