...
-- AlterTable
ALTER TABLE "Course" ADD COLUMN IF NOT EXISTS     "outcomes" TEXT[] DEFAULT ARRAY[]::TEXT[],
ADD COLUMN IF NOT EXISTS     "skills" TEXT[] DEFAULT ARRAY[]::TEXT[];

-- AlterTable
ALTER TABLE "JobOpportunity" ADD COLUMN IF NOT EXISTS     "applicationCount" INTEGER NOT NULL DEFAULT 0,
